...
export async function loader({ params }) {
    const product = await(await fetch(`${config.url}/api/products/${params.product}`)).json();
...
export default function ProductEdit() {
    ...
    const [contents, setContents] = useState((product.content)? product.content : []);
            ...
            <div className="container">
                ...
                <Form className="row gy-3" method="post" encType="multipart/form-data" onSubmit={() => {
                    ...
                    <div className="col-6">
                        ...
                        <input className="form-control" id="name" name="name" type="text" placeholder="Example: Guitar XM-6125" value={name} onChange={(event) => {
                            setName(event.currentTarget.value);
                        }} required />
                    </div>
                    <div className="col-6">
                        <label htmlFor="category">Categorie</label>
                        <select className="form-select" id="category" name="category" type="text" value={category} onChange={(event) => {
                    ...
                    <div className="col-4">
                        ...
                        <div className="input-group">
                            <input className="form-control text-center" id="price" name="price" type="number" placeholder="42" value={price} onChange={(event) => {
                    ...
                    <div className="col-4">
                        ...
                        <div className="input-group">
                            <input className="form-control text-center" id="quantity" name="quantity" type="number" placeholder="42" value={quantity} onChange={(event) => {
                    ...
                    <div className="col-4">
                        ...
                        <div className="input-group">
                            ...
                            <input className="form-control text-center" id="discount" name="discount" type="number" placeholder="5" value={ discount } onChange={(event) => {
                    ...
                    <div className="col-4">
                        ...
                        <div className="input-group">
                            ...
                            <input className="form-control text-center" id="discountRate" name="discountRate" type="number" placeholder="7" value={ product.discountRate } onChange={(event) => {
                            setDiscountRate(event.currentTarget.value);
                        }} />
                            <span className="input-group-text">
                                %
                            </span>
                    ...
                    <div className="col-12 d-flex">
                        <div className="w-50 me-1">
                            ...
                            <textarea className="form-control w-100 h-100" rows={15} id="description" name="description" value={description} onChange={(event) => {
