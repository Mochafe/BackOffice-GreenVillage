...
function makeCategoryOption(categories) {
    ...
    categories["hydra:member"].forEach(value => {
        if (value.parent) {
            buff.push(
                <option value={value.id} key={"opt-" + value.id}>{value.name}</option>
            )
        }
        ...
        <div className="container-fluid">
            ...
            <div className="row mt-3">
                <div className="col-3 ps-0">
                    ...
                    <Link to={"/product/new"} className="product-add-button">
                            ...
                            products["hydra:member"].map((product) => (
                                <div className="col-4" key={product.id}>
                                    <div className="card mb-3">
                                        ...
                                        <img src={(product.images.length > 0)? config.url + product.images[0].path : "image/product-placeholder.jpg" } className="card-img-top card-product-img" alt={ (product.images.length > 0)? product.images[0].title : "Image placeholder" } />
                                        <div className="card-body">
                                            ...
                                            <div className="d-flex mt-3 justify-content-around">
                                                <Link to={`/product/${product.id}/view`} className="text-primary" key={"view-" + product.id}>
                                                ...
                                                <Link to={`/product/${product.id}/edit`} className="text-info" key={"edit-" + product.id}>
                                                ...
                                                <Form method="delete" action={`/product/${product.id}/delete`} key={"delete-" + product.id}>
